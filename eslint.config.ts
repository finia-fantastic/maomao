...
export default defineConfig({
  ...
  rules: {
    ...
    // Slimmed to the desktop-only surface: the shared catalog is kept as a stable
    // version-pin superset, so entries whose only consumers were removed (web/pocket/
    // services/plugins) are intentionally unused rather than pruned.
